...
class _InputState extends State<Input> {
  ...
  Widget _inputBuilder() {
    ...
    final placeholderTextDirection = intl.Bidi.detectRtlDirectionality(InheritedL10n.of(context).l10n.inputPlaceholder)
        ? TextDirection.rtl
        : TextDirection.ltr;

    final textDirection = _textController.text.isEmpty
        ? intl.Bidi.detectRtlDirectionality(InheritedL10n.of(context).l10n.inputPlaceholder)
            ? TextDirection.rtl
            : TextDirection.ltr
        : intl.Bidi.detectRtlDirectionality(_textController.text)
            ? TextDirection.rtl
            : TextDirection.ltr;
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InheritedChatTheme.of(context).theme.inputTextDecoration.copyWith(
                            ...
                            hintTextDirection: placeholderTextDirection,
                          ),
