...
- Check provider usage in `flyer_chat_text_message` package, see if it will work if users supply their own text message implementation. Adjust the code in the input to have similar approach.
- Update folder structure for tests in `flutter_chat_core` package.
- Play with `shrinkWrap` propety of animated list.
- Check if I need wrappers for provider usage
- Check private variables usage with _ everywhere
