...
class _$ChatThemeImpl extends _ChatTheme {
  ...
  @override
  String toString() {
    return 'ChatTheme(backgroundColor: $backgroundColor, fontFamily: $fontFamily, imagePlaceholderColor: $imagePlaceholderColor, inputTheme: $inputTheme, textMessageTheme: $textMessageTheme)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, backgroundColor, fontFamily,
      imagePlaceholderColor, inputTheme, textMessageTheme);
}
