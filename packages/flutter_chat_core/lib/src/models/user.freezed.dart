...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserID id,  String? name,  String? imageSource, @EpochDateTimeConverter()  DateTime? createdAt,  Map<String, dynamic>? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.name,_that.imageSource,_that.createdAt,_that.metadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserID id,  String? name,  String? imageSource, @EpochDateTimeConverter()  DateTime? createdAt,  Map<String, dynamic>? metadata)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.name,_that.imageSource,_that.createdAt,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserID id,  String? name,  String? imageSource, @EpochDateTimeConverter()  DateTime? createdAt,  Map<String, dynamic>? metadata)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.name,_that.imageSource,_that.createdAt,_that.metadata);case _:
  return null;
